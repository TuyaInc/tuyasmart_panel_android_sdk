package com.tuya.panelsdkdemo.base.widget.contact;
...
public class IndexScroller {
    ...
    private int indexPaintColor = Color.BLACK; // color for section title
    ...
    public IndexScroller(Context context, ListView lv) {
        ...
        indexPaint.setTextSize(16 * mScaledDensity);
    }
    ...
    public void drawIndexBarContainer(Canvas canvas) {
        ...
        indexbarContainerPaint.setAlpha(25); // opacity
