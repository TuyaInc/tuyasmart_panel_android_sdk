...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    private List<MainActivity.ItemBean> mData;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int position) {
        final MainActivity.ItemBean bean = mData.get(position);
        if (bean == null) {
            return;
        }
    ...
    public void setData(List<MainActivity.ItemBean> beans) {
        mData = beans;
    ...
    public interface OnItemClickListener {
        void onItemClick(MainActivity.ItemBean bean, int position);
    }
}
